...
class Rom:
    ...
    def find_everything(self) -> None:
        ...
        misc_art = [
            ...
            (0x09, 0x2000, "Title Screen, VRAM $0000"),
            (0x09, 0x4B0A, "Title Screen, VRAM $2000"),
            (0x09, 0x351F, "Game Over Screen, VRAM $0000"),
            (0x09, 0xB92E, "Score Tally Screen, VRAM $3000"),
            (0x09, 0x351F, "Score Tally Screen, VRAM $0000"),
            (0x09, 0xB92E, "Common Level Art, VRAM $3000"),
            (0x0C, 0x0000, "Ending Tally Screen, VRAM $0000"),
            (0x0C, 0x1801, "Credits Screen, VRAM $0000"),
            (0x09, 0x4B0A, "Credits Screen, VRAM $2000"),
            (0x09, 0x4294, "Signpost, VRAM $2000"),
            (0x09, 0xAEB1, "GHZ3 Boss, VRAM $2000"),
            (0x0C, 0xDA28, "Animal Capsule and Animals, VRAM $2000"),
        ...
        artmaps = [
            ...
            (0x6000, 0x012E, "Title Screen, high byte $00"),
            (0x67FE, 0x0032, "Game Over Screen, high byte $00"),
            (0x612E, 0x00BB, "Score Tally, Normal, high byte $00"),
            (0x61E9, 0x0095, "Score Tally, Special, high byte $00"),
            (0x6830, 0x0179, "Ending Tally Screen, high byte $00"),
            (0x69A9, 0x0145, "Good Ending Island Scene, high byte $00"),
            (0x6AEE, 0x0173, "UNUSED beta credits backdrop, high byte $00"),
            (0x6C61, 0x0189, "Credits Screen, high byte $00"),
        ]
