...
proc main {rompath} {
   ...
   set ::ci_scaleimg_00 [.maincanvas create image [expr {$::render_scale*8}] 0 -image scaleimg -anchor nw]
...
proc async_main {} {
   ...
   scaleimg copy mainimg -compositingrule set -zoom $::render_scale -from 8 0 256 192
}
